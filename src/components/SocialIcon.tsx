...
const SocialIcon = ({ icon, title, link }: SocialIconPropsType) => {
    ...
    return (
        <a href={link} target="_blank" className="w-[60px] h-[60px] z-10 inline-block float-left mx-1 violet-gradient rounded-[50px] overflow-hidden shadow-lg transition-all hover:w-[200px]">
